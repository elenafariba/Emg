...
const server = http.createServer((req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            h2 { font-size: 18px; color: #58a6ff; margin-bottom: 15px; }
            textarea { width: 100%; height: 90px; background: #0d1117; color: #7ee787; border: 1px solid #30363d; border-radius: 8px; padding: 10px; box-sizing: border-box; font-size: 12px; word-break: break-all; resize: none; }
            button { background: #238636; color: white; border: none; padding: 14px; margin-top: 15px; border-radius: 8px; cursor: pointer; font-size: 16px; font-weight: bold; width: 100%; transition: 0.2s; }
            button:active { background: #2ea043; transform: scale(0.98); }
        </style>
    </head>
    <body>
        <div class="card">
            <h2>✅ کانفیگ VLESS آماده است</h2>
